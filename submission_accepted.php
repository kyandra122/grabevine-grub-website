...
.vines {
  ...
  width: 100%;
  height: 100%;
  animation: vineAnimation 10s linear infinite;
}

  </style>
</head>
<body style="margin: 0; padding: 0; background:#eceff4; min-height: 100vh;">
  ...
  <div class="content">
    <h1 style="color:black">Your submission has been accepted!</h1>
    <h1 style="color:black">THANK YOU!!</h1>

    <p style="color:black">If you want to check out previous submissions, <a href="previous_submissions.php">click here</a>.</p>
